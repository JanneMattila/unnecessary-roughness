...
var _IMAGE_HUMAN1 = 5;
var _IMAGE_HUMAN1_FACE_DOWN = 6;
var _IMAGE_HUMAN1_FACE_UP = 7;
var _IMAGE_ORC1 = 8;
var _IMAGE_ORC1_FACE_DOWN = 9;
var _IMAGE_ORC1_FACE_UP = 10;
var _FLOOR_SIZE = 60;
function loadImages() {
    var theme = "granite";
    var files = [
        "floor.png", "floor2.png", "floor3.png",
        "ball.png", "ball_animation.png",
        "human.png", "human_face_down.png", "human_face_up.png",
        "orc_black_orc.png", "orc_black_orc_face_down.png", "orc_black_orc_face_up.png"
    ];
...
function gameViewAnimationFrame(timestamp) {
    ...
    if ((_animationPlayers != null && _animationPlayers.length > 0) ||
        ...
        DotNet.invokeMethod("BloodBowl.Blazor.Client", "AnimationEnded");
    }
}
...
function drawCanvas(game) {
    ...
    if (_imagesLoaded === _imagesToLoad) {
        ...
        //_context.fillStyle = "rgba(255,255,153, 0.3)";
        //_context.beginPath();
        //_context.fillRect(0, 0, _FLOOR_SIZE * 2, _FLOOR_SIZE * 2);
        //_context.fill();
        //_context.restore();
        //// Green
        //_context.save();
        //_context.fillStyle = "rgba(144,238,144, 0.3)";
        //_context.beginPath();
        //_context.fillRect(0, _FLOOR_SIZE * 2, _FLOOR_SIZE * 2, _FLOOR_SIZE * 2);
        //_context.fill();
        //_context.restore();
        //// Red
        //_context.save();
        //_context.fillStyle = "rgba(240,128,128, 0.3)";
        //_context.beginPath();
        //_context.fillRect(0, _FLOOR_SIZE * 4, _FLOOR_SIZE * 2, _FLOOR_SIZE);
        //_context.fill();
        //_context.restore();
        ...
        for (var p = 0; p < game.homeTeam.players.length; p++) {
            ...
            if (x != -1) {
                var inAnimation = drawPlayer(_context, player, _IMAGE_HUMAN1, x, y, player.rotation, selectedPlayerX, selectedPlayerY);
        ...
        for (var p = 0; p < game.visitorTeam.players.length; p++) {
            ...
            var y = player.boardPosition.y;
            if (x != -1) {
                var inAnimation = drawPlayer(_context, player, _IMAGE_ORC1, x, y, player.rotation, selectedPlayerX, selectedPlayerY);
                if (inAnimation == false && x == game.ball.boardPosition.x && y == game.ball.boardPosition.y) {
                    ballInPlayersHands = true;
                }
            }
        ...
        //    for (let y = 0; y < 26; y++) {
        //        if (x === 5 && y === 5) {
        //            _context.drawImage(_images[_IMAGE_HUMAN1], x * _FLOOR_SIZE, y * _FLOOR_SIZE);
        //            _context.drawImage(_images[_IMAGE_BALL], x * _FLOOR_SIZE, y * _FLOOR_SIZE);
        //        }
        //        else if (x === 7 && y === 5) {
        //            _context.drawImage(_images[_IMAGE_HUMAN1_FACE_DOWN], x * _FLOOR_SIZE, y * _FLOOR_SIZE);
        //        }
        //        else if (x === 9 && y === 5) {
        //            _context.drawImage(_images[_IMAGE_HUMAN1_FACE_UP], x * _FLOOR_SIZE, y * _FLOOR_SIZE);
        //        }
        //        if (x === 5 && y === 7) {
        //            _context.drawImage(_images[_IMAGE_ORC1], x * _FLOOR_SIZE, y * _FLOOR_SIZE);
        //        }
        //        if (x === 5 && y === 9) {
        //            _context.save();
        //            _context.translate(x * _FLOOR_SIZE + _FLOOR_SIZE / 2, y * _FLOOR_SIZE + _FLOOR_SIZE / 2);
        //            _context.rotate(Math.PI / 2);
        //            _context.translate(-_FLOOR_SIZE / 2, -_FLOOR_SIZE / 2);
        //            _context.drawImage(_images[_IMAGE_HUMAN1], 0, 0);
        //            _context.restore();
        //        }
        //    }
        //}
...
function calculatePosition(event) {
    if (!_animationRunning) {
        ...
        console.log(_game);
        DotNet.invokeMethod("BloodBowl.Blazor.Client", "CanvasClickReceived", x, y);
    }
}
...
document.addEventListener("keyup", function (event) {
    if (event.keyCode != 123 /* F12 */) {
        event.preventDefault();
        if (!_animationRunning) {
            DotNet.invokeMethod("BloodBowl.Blazor.Client", "CanvasKeyUpReceived", event.keyCode);
        }
    }
});
